        ...
        <main className="flex-1 p-6">
           ...
           <div className="grid grid-cols-3 gap-4 mt-4">
            <a href="#" className="bg-white/5 group rounded-md flex items-center gap-4 overflow-hidden hover:bg-white/10 transition-colors">
              <Image src="/album.jpg" width={104} height={104} alt="Capa do álbum do cantor Kamaitachi" />
              <strong>Kamaitachi</strong>
           ...
           <h2 className="font-semibold text-2xl mt-10">Made for gigico</h2>

           <div className="grid grid-cols-5 gap-4 mt-4">
            <a href="#" className="bg-white/5 p-3 rounded-md flex flex-col gap-2 hover:bg-white/10 transition-colors">
              <Image src="/album.jpg" className="w-full" width={120} height={120} alt="Capa do álbum do cantor Kamaitachi" />
